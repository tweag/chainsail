...
def mock_config():
    config = SchedulerConfig(
        controller=GeneralNodeConfig(image="foo:latest", cmd="echo", args=["bar"], ports=[8080], user_code_image="bar:earliest"),
        worker=GeneralNodeConfig(image="foo:latest", cmd="echo", args=["bar"], ports=[8080], user_code_image="bar:earliest"),
        node_type="mock",
